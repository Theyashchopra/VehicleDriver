...
public class AppointmentOwnerData {
    ...
    public AppointmentOwnerData(int id, int owner_id, int vehicle_id, String customer_name, String address, String customer_mobile, String alternate_mobile, String owner_name, String start_day, String end_day, String time) {
        this.id = id;
